...
PATCHFILES="ar/ar-ranlibpath.diff ar/contents.diff ar/declare_localtime.diff \
ar/errno.diff as/arm.c.diff as/bignum.diff as/getc_unlocked.diff \
as/input-scrub.diff as/messages.diff as/relax.diff \
...
otool/nolibmstub.diff otool/old_abi.diff ld64/LTOReader-setasmpath.diff \
